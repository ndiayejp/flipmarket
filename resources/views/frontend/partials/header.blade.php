      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            @auth
            <li><a href="#"><i class="icon fa fa-user"></i>{{__('Account')}}</a></li>
            <li><a href="#"><i class="icon fa fa-heart"></i>{{__('Wishlist')}}</a></li>
            <li><a href="#"><i class="icon fa fa-shopping-cart"></i>{{__('Cart')}}</a></li>
            <li><a href="#"><i class="icon fa fa-check"></i>{{__('Payment')}}</a></li>
            <li><a href="#"><i class="icon fa fa-user"></i> {{__('Profile')}}</a></li>
            @else
        ...
        <div class="cnt-block">
          <ul class="list-unstyled list-inline">
            ...
            <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown"
                data-toggle="dropdown"><span class="value">{{__('French')}} </span><b class="caret"></b></a>
              <ul class="dropdown-menu">
              ...
              <div class="control-group">
                <ul class="categories-filter animate-dropdown">
                  <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown"
                      href="category.html">Catégories <b class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu">
                      <li class="menu-header">Ordinateurs</li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Habits</a>
                      </li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Electroniques</a>
                      </li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Chaussures</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Montres</a></li>
                    </ul>
                  </li>
                </ul>
        ...
        <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
          ...
          <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
              <div class="items-cart-inner">
                ...
                <div class="total-price-basket"> <span class="lbl">{{__('Cart')}}</span>   </div>
              </div>
            </a>
            <ul class="dropdown-menu">
              <li>
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
                <li class="active dropdown yamm-fw"> <a href="{{route('home')}}" data-hover="dropdown" class="dropdown-toggle"
                    data-toggle="dropdown">{{__('Home')}}</a> </li>
